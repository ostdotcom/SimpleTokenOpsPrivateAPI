...
const publicEthereum = {
  ...
  getAddressesSizeForBonuses: function(contractAddress) {
  ...
  getAddressesForBonuses: function(contractAddress) {
  ...
  getProcessableStatus: function(address, contractAddress) {

    const token = jwtAuth.issueToken({address: address, contractAddress: contractAddress}, 'publicOps')
        , params = {token: token};
